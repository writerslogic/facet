...
- **Attested SPDX SBOM** (`actions/attest-sbom`) — a Software Bill of Materials for each release,
  signed against the same tarballs and uploaded as a build artifact.

All GitHub Actions are pinned to full commit SHAs, and CodeQL, OpenSSF Scorecard, and Dependency
Review run in CI.
